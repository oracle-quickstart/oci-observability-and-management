...
GRANT EXECUTE on ap_utilities_pkg TO APPSRO;
...
GRANT EXECUTE on ap_invoices_utility_pkg TO APPSRO;
...
GRANT EXECUTE on fnd_date TO APPSRO;
...
GRANT EXECUTE on ap_acctg_data_fix_pkg TO APPSRO;
...
GRANT EXECUTE on fnd_profile TO APPSRO;
...
GRANT EXECUTE on ap_invoices_pkg TO APPSRO;
...
GRANT EXECUTE on ap_payment_util_pkg TO APPSRO;
...
GRANT EXECUTE on fnd_irep_loader_private TO APPSRO;
...
GRANT EXECUTE on pa_nl_installed TO APPSRO;
...
GRANT EXECUTE on pa_project_structure_utils TO APPSRO;
GRANT SELECT on apps.pa_project_statuses TO APPSRO;
GRANT EXECUTE on pa_workplan_attr_utils TO APPSRO;
...
GRANT EXECUTE on wf_purge TO APPSRO;
...
GRANT EXECUTE on hr_general TO APPSRO;
...
GRANT EXECUTE on pa_proj_task_struc_pub TO APPSRO;
